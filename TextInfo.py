...
ui_obj_info = {"Buildings": ["Factory", "StoneWall", "Dormatory", "Metal Wall", "Raindeer Farm", "Work Shop", "BlackSmith", "Fire Station", "Material Depot", "Candy Shop", "Igloo", "Encampment", "Research Shop", "Hospital", "Lumbermill", "Quary", "Farm", "Lab", "Snow Tower", "Pasture", "Pass", "Pebble Site"],
               "People": ["Person"],
               "Boats": ["Cannoe", "Viking Long Ship"]}

unlocked = {None: False, "Factory": False, "StoneWall": True, "Dormatory": False, "Metal Wall": False, "Raindeer Farm": False, "Work Shop": False, "BlackSmith": False, "Viking Long Ship": False, "Fire Station": True, "Material Depot": False, "Candy Shop": False, "Igloo": True, "Bad Reporter": False, "Bad Gifter": False, "Encampment": True,
...
objects = {"Factory": Factory, "StoneWall": StoneWall, "Dormatory": Dormatory, "Metal Wall": MetalWall, "Raindeer Farm": RaindeerFarm, "Work Shop": WorkShop, "BlackSmith": BlackSmith, "Cannoe": Cannoe, "Viking Long Ship": VikingLongShip, "Fire Station": FireStation, "Material Depot": MaterialDepot, "Candy Shop": CandyShop,
...
requirements = {"Factory": {"metal": 5}, "StoneWall": {"stone": 1}, "Dormatory": {"wood": 10, "stone": 2}, "Metal Wall": {"metal": 1}, "Raindeer Farm": {"presents": 50, "wood": 5}, "Work Shop": {"wood": 5, "stone": 5}, "BlackSmith": {"wood": 10, "stone": 25}, "Cannoe": {"wood": 5}, "Viking Long Ship": {"wood": 10}, "Fire Station": {}, "Material Depot": {"wood": 5}, "Candy Shop": {"wood": 5}, "Igloo": {
...
tiles = {"Factory": Land, "StoneWall": Land, "Dormatory": Land, "Metal Wall": Land, "Raindeer Farm": Land, "Work Shop": Land, "BlackSmith": Land, "Cannoe": Sea, "Viking Long Ship": Sea, "Fire Station": Land, "Material Depot": Land, "Candy Shop": Land,
...
times = {"Factory": 20, "StoneWall": 2, "Dormatory": 10, "Metal Wall": 5, "Raindeer Farm": 0, "Work Shop": 10, "BlackSmith": 25, "Cannoe": 5, "Viking Long Ship": .2, "Fire Station": .2, "Material Depot": 10, "Candy Shop": 5,
         "Igloo": 5, 'Encampment': 10, 'Research Shop': 10, 'Hospital': 15, 'Lumbermill': 5, 'Quary': 5, "Person": 0, "Farm": 10, "Bad_Cannoe": 5, "Lab": 10, "Snow Tower": 10, "Pasture": 5, "Pass": 5, "Pebble Site": 10}
max_length = {"Factory": 2, "StoneWall": 1, "Dormatory": 2, "Metal Wall": 3, "Raindeer Farm": 1, "Work Shop": 1, "BlackSmith": 1, "Fire Station": 1, "Material Depot": 1,
              "Candy Shop": 1, "Igloo": 1, "Encampment": 1, 'Hospital': 1, 'Lumbermill': 1, 'Quary': 2, "Research Shop": 2, "Farm": 1, "Lab": 2, "Snow Tower": 2, "Pass": 1, "Pebble Site": 1}
...
preview_textures = {
    ...
    "Candy Shop": {"path": "resources/Sprites/buildings/FoodDepot.png"},
